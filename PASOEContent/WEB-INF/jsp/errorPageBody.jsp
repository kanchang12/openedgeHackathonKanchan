...
<tr><td><b>HTTP status:</b></td> <td> <%=(Integer)request.getAttribute("jakarta.servlet.error.status_code")%> </td> </tr>
...
<tr><td><b>Servlet name:</b></td> <td> <%=(String)request.getAttribute("jakarta.servlet.error.servlet_name")%> </td> </tr>
<tr><td><b>URI:</b></td> <td> <%=(String)request.getAttribute("jakarta.servlet.error.request_uri")%> </td> </tr>
